...
public class SPService {
    ...
    public static final String DEVICE_MODE = "device_mode"; // "phone" 或 "emulator"
    public static final String CLOUD_PAY_ID = "cloud_pay_id";
    public static final String SP_TASK_RUNNING = "task_running"; // 任务是否正在运行
    public static final String DETECT_ENABLED = "detect_enabled"; // 是否启用OCR识别点赞
